...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, updateProduct, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, productInstance.update(product)];
            case 1:
...
var productRoutes = function (app) {
    ...
    app.post('/products', token_1.verifyToken, create);
    app.put('/products', token_1.verifyToken, update);
    app.delete('/products/:id', token_1.verifyToken, destroy);
};
