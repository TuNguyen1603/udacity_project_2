    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orderInstance.create(order)];
            case 1:
                newOrder = _a.sent();
                res.json(newOrder);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orderInstance.update(order)];
            case 1:
                updateOrder = _a.sent();
...
var orderRoutes = function (app) {
    ...
    app.post('/orders', token_1.verifyToken, create);
    app.put('/orders', token_1.verifyToken, update);
    app.delete('/orders/:id', token_1.verifyToken, destroy);
};
