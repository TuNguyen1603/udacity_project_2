...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newUser = _a.sent();
                token = jsonwebtoken_1.default.sign({ user: newUser }, process.env.TOKEN_SECRECT);
                res.json(token);
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userInstance.update(user)];
            case 1:
                updateUser = _a.sent();
                res.json(updateUser);
                return [3 /*break*/, 3];
...
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userInstance.authenticate(user.username, user.password)];
            case 2:
                u = _a.sent();
                if (!u) {
                    return [2 /*return*/, res.status(401).send('Wrong password!')];
                }
                token = jsonwebtoken_1.default.sign({ u: u }, process.env.TOKEN_SECRECT);
                res.json(token);
                return [3 /*break*/, 4];
            case 3:
                error_4 = _a.sent();
...
var userRoutes = function (app) {
    ...
    app.put('/users', token_1.verifyToken, update);
    app.delete('/users/:id', token_1.verifyToken, destroy);
